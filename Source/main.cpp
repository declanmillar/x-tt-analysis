...
int main(int argc, char* argv[])
{
  ...
  desc.add_options()
      ...
      ("discard,d", po::bool_switch()->default_value(false), "discard complex")
      ("ggG,g", po::bool_switch()->default_value(true), "add qqG")
      ("qqG,q", po::bool_switch()->default_value(true), "add qqG")
      ("verbose,v", po::bool_switch()->default_value(false), "run in verbose mode")
      ("ytt,y", po::value<double>()->default_value(0), "set ytt cut")
      ("xsec,x", po::bool_switch()->default_value(true), "calculate differential cross section")
      ("fid,F", po::bool_switch()->default_value(false), "calculate fiducial differential cross section")
  ;
