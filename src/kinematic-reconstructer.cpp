...
bool KinematicReconstructer::Reconstruct(const std::pair<TLorentzVector, TLorentzVector>& p_l,
...
std::vector<std::pair<TLorentzVector, TLorentzVector> > KinematicReconstructer::GetSolutions(const TLorentzVector& p_l1, const TLorentzVector& p_l2,
