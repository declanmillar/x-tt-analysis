...
std::pair< TLorentzVector, TLorentzVector > MatchBjetsToLeps( const std::pair< TLorentzVector, TLorentzVector >& p_l, const std::pair< TLorentzVector, TLorentzVector >& p_b )
{
    std::pair< TLorentzVector, TLorentzVector > p_b_match;
    ...
    int imin = 0;
    for ( int i = 1; i < 4; i++ ) if ( deltaR[i] < deltaR[ imin ] ) imin = i;
